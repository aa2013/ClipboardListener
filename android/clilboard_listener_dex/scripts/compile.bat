@echo off
set ANDROID_JAR=C:\Users\admin\AppData\Local\Android\Sdk\platforms\android-35/android.jar
set D8_TOOL=C:\Users\admin\AppData\Local\Android\Sdk\build-tools\35.0.0\d8
